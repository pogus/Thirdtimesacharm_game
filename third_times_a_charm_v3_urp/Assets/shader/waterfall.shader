Shader "Water/waterfall" {
    Properties {
        ...
        _FlowSpeed ("Flow Speed", Range(0, 5)) = 1 // New flow speed property
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            uniform float _FlowSpeed; // New flow speed variable
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                // Adjusting water movement by multiplying with _FlowSpeed
                float4 node_1507 = _Time * _FlowSpeed; // Apply flow speed multiplier
                ...
                float3 emissive = saturate((1.0 - (1.0 - _WaterColor.rgb) * (1.0 - saturate((saturate((_FoamTexture_var.r > 0.5 ? 
                (1.0 - (1.0 - 2.0 * (_FoamTexture_var.r - 0.5)) * (1.0 - _Higlight_var.rgb)) : 
                (2.0 * _FoamTexture_var.r * _Higlight_var.rgb))) * _FoamOpacity)))));
