...
public class CoinBehavior : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            // Find the ScoreManager on the player or its children
            ScoreManager scoreManager = other.GetComponentInChildren<ScoreManager>();
            ...
            {
                Debug.LogError("ScoreManager not found on the player!");
            }
